...
const RockPaperScissors: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      <h2 className="text-3xl font-bold mb-4 text-cyan-400">Rock Paper Scissors</h2>
      <div className="flex justify-around w-full max-w-md my-6 text-slate-400">
        <div className="text-xl">Player: <span className="font-bold text-green-400">{scores.player}</span></div>
        <div className="text-xl">Computer: <span className="font-bold text-red-400">{scores.computer}</span></div>
      </div>
